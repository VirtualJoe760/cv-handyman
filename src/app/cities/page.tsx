...
const Cities: React.FC = () => {
  ...
  const city = coachellaValleyCities.find((c) => c.id === citiesPageContent.hero.cityId);

  if (!city) {
    return <div className="text-red-500 text-center">{citiesPageContent.cityNotFound}</div>; // Handle case where city is not found
  }
